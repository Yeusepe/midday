  ...
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect ChatGPT to your Creator Payments account via MCP. No API key needed —
      ...
      <div className="space-y-2.5">
        ...
        <ol className="space-y-2.5">
          ...
          <SetupStep number={3}>
            When you use a Creator Payments tool, you'll be prompted to sign in and select
            a team
          </SetupStep>
        </ol>
      </div>
...
export function GeminiSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Gemini CLI to your Creator Payments account via MCP. No API key needed —
        authentication is handled automatically via OAuth.
      </p>

      <div className="space-y-2">
        <p className="text-xs text-[#878787]">
          Run this command to add the Creator Payments MCP server:
        </p>
        <CopyableCode code="gemini mcp add --transport http midday https://api.payments.yucp.club/mcp" />
      </div>
      ...
      <div className="space-y-2.5">
        ...
        <ol className="space-y-2.5">
          ...
          <SetupStep number={2}>
            When prompted, sign in to Creator Payments in your browser and select a team
          </SetupStep>
          <SetupStep number={3}>
            Use Creator Payments tools in Gemini CLI to access your financial data
          </SetupStep>
        </ol>
      </div>
...
export function WindsurfSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Windsurf to your Creator Payments account via MCP. No API key needed —
        authentication is handled automatically via OAuth.
      </p>
...
export function ClineSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Cline to your Creator Payments account via MCP. No API key needed —
        authentication is handled automatically via OAuth.
      </p>
...
export function ZedSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Zed to your Creator Payments account via MCP. No API key needed —
        authentication is handled automatically via OAuth.
      </p>
...
export function ManusSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Manus to your Creator Payments account via MCP.
      </p>
...
export function ClaudeSetupInstructions() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-[#878787]">
        Connect Claude to your Creator Payments account via MCP. No API key needed —
        authentication is handled automatically via OAuth.
      </p>
      ...
      <Tabs defaultValue="connect" className="w-full">
        ...
        <TabsContent value="connect" className="space-y-4 mt-3">
          ...
          <div className="space-y-2.5">
            ...
            <ol className="space-y-2.5">
              ...
              <SetupStep number={3}>
                When you use a Creator Payments tool, you'll be prompted to sign in and
                select a team
              </SetupStep>
            </ol>
          </div>
        ...
        <TabsContent value="code" className="space-y-4 mt-3">
          <div className="space-y-2">
            ...
            <CopyableCode code="claude mcp add --transport http midday https://api.payments.yucp.club/mcp" />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <ol className="space-y-2.5">
              ...
              <SetupStep number={2}>
                When prompted, sign in to Creator Payments in your browser and select a
                team
              </SetupStep>
              <SetupStep number={3}>
