...
export const metadata = createPageMetadata({
  ...
  description:
    "Creator Payments CLI and MCP server let AI agents create invoices, reconcile transactions, track time, and manage your finances from any tool.",
  path: "/agents",
