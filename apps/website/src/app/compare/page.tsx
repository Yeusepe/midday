...
const title = `Compare Creator Payments to QuickBooks, Xero, FreshBooks & More (${year})`;
const description =
  "Looking for QuickBooks, Xero, or FreshBooks alternatives? Compare Creator Payments to popular accounting and finance tools. Built for founders, not accountants. Free 14-day trial.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Compare Creator Payments to alternatives",
      },
    ],
  },
  twitter: {
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <h1 className="font-serif text-3xl lg:text-4xl text-foreground mb-4">
            Compare Creator Payments to alternatives
          </h1>
          <p className="font-sans text-base text-muted-foreground max-w-2xl mx-auto">
            Creator Payments is built for founders and small teams who want clarity over
