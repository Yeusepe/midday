---
title: API Reference
description: Access your Creator Payments data programmatically through the REST API.
section: developer
order: 1
---

The Creator Payments API lets you access your financial data programmatically. Build custom integrations, automate workflows, or connect Creator Payments to your own tools.
...
The Creator Payments API supports two authentication methods:

### API Keys (for your own data)

For accessing your own Creator Payments data in scripts, automations, or personal tools.
...
For building apps that access other users' Creator Payments data with their permission.
...
```
https://api.payments.yucp.club/v1
```
