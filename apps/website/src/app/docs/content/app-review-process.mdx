...
description: Get your OAuth app verified and listed in the Creator Payments app directory.
section: developer
order: 5
---

Once your OAuth app is working, you can submit it for review. Verified apps display a trust badge and can be listed in the Creator Payments app directory for users to discover.

## Why get verified?

### For users

- **Trust badge**: Verified apps show users that Creator Payments has reviewed the app
...
- **App directory listing**: Reach Creator Payments' user base
- **Partnership opportunities**: Connect with the Creator Payments team
...
- Apps work fully
- Users see a warning: "This app hasn't been verified by Creator Payments yet"
...
- [ ] App works with different Creator Payments accounts
...
After approval, you can opt to list your app in the Creator Payments app directory:
...
- Don't include "Creator Payments" unless you have permission
- Avoid misleading names that imply official Creator Payments features
...
- **Email**: [contact@yucp.club](mailto:contact@yucp.club)
