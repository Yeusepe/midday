...
The Creator Payments MCP server gives AI tools like Claude, Cursor, ChatGPT, and Raycast full access to your business data — not just reading, but creating invoices, managing transactions, tracking time, and exporting to your accountant.

## What is MCP?

Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. Instead of copying and pasting data, MCP lets AI tools work with your Creator Payments account directly and securely.

## Supported tools

Creator Payments MCP works with:
...
Add Creator Payments to your Claude Desktop configuration.
...
### Add Creator Payments configuration
...
After saving, restart Claude Desktop. You should see Creator Payments in your available tools.
...
Use Creator Payments data while coding in Cursor.
...
Use Creator Payments with ChatGPT via custom GPTs or plugins.

### Custom GPT approach

1. Create a Custom GPT in ChatGPT
2. Add actions that call the Creator Payments API
3. Configure authentication with your API key

### Configuration

Use the Creator Payments API endpoints with your API key in the Authorization header:
...
Access Creator Payments from Raycast on Mac.

### Install the extension

1. Open Raycast
2. Search for "Creator Payments" in the Store
3. Install the extension

### Configure

1. Open Raycast preferences
2. Find the Creator Payments extension
3. Enter your API key

### Use it

Trigger Raycast and use Creator Payments commands to query your financial data.
...
>
> **Assistant**: Based on your Creator Payments data:
> - Cash balance: $45,230
