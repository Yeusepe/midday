...
description: How Creator Payments uses AI to categorize your transactions and how categories affect your metrics.
section: banking
order: 4
---

Every transaction that flows into Creator Payments is automatically categorized using AI. This saves hours of manual work and keeps your books organized for accounting.

## How it works

When a new transaction arrives, Creator Payments' AI:
...
The AI learns from your corrections. The more you use Creator Payments, the more accurate it becomes for your specific business.

## Category structure

Creator Payments uses a two-level category system designed for business accounting:
...
Creator Payments uses a standard category set that maps to accounting charts of accounts. This ensures consistency for exports and integrations. Use tags for custom groupings.
