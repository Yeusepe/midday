...
description: How the transaction export flow works in Creator Payments.
section: export
order: 1
---

Creator Payments tracks each transaction through a clear lifecycle so you always know what needs attention and what's been exported.
...
| **Receipt found** | Creator Payments found a possible receipt match. Confirm or dismiss it. |
...
2. Creator Payments finds a matching receipt automatically (status: **Receipt found**)
...
| **Mark exported** | Manually marks as exported (use only if exported outside Creator Payments) |
