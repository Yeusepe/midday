...
Most bank exports work directly. Creator Payments maps common formats automatically.
...
4. Map columns to Creator Payments fields
5. Review the preview
6. Confirm import

## Column mapping

If Creator Payments doesn't recognize your columns automatically:

1. Match each CSV column to a Creator Payments field
...
- Creator Payments checks for duplicates based on date, amount, and description
