...
description: How Creator Payments handles multiple currencies and exchange rates.
section: banking
order: 7
---

Creator Payments supports businesses operating in multiple currencies. Connect accounts in different currencies, track international transactions, and see unified reports in your base currency.
...
You can connect bank accounts in any currency Creator Payments supports.
...
Creator Payments uses market exchange rates to convert currencies.
...
Creator Payments uses reliable market rates updated daily. Rates are for display purposes and may differ slightly from your bank's rates.
...
For tax purposes, you may need to track original currency amounts. Creator Payments stores both the original and converted amounts for every transaction.

## Supported currencies

Creator Payments supports all major world currencies including:
