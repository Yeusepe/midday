...
description: Technical reference for Creator Payments OAuth 2.0 endpoints.
section: developer
order: 4
---

Complete technical reference for Creator Payments' OAuth 2.0 implementation. These endpoints follow the [OAuth 2.0 RFC 6749](https://tools.ietf.org/html/rfc6749) and [PKCE RFC 7636](https://tools.ietf.org/html/rfc7636) specifications.
...
| Token & API | `https://api.payments.yucp.club/v1` |
...
```
POST https://api.payments.yucp.club/v1/oauth/token
```
...
```
POST https://api.payments.yucp.club/v1/oauth/revoke
```
...
Once you have an access token, use the Creator Payments SDK for API requests:
