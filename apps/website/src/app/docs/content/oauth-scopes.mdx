...
description: Complete list of OAuth scopes for Creator Payments API access.
section: developer
order: 3
---
...
1. Creator Payments validates requested scopes against your app's registered scopes
