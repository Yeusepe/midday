...
Your revenue forecast shows how much money you can expect to receive in the coming months. Unlike simple projections that just extend past trends, Creator Payments builds your forecast from real, known sources of incoming revenue.
...
- **Projected revenue**: What Creator Payments expects you'll receive (dashed line)
- **Confidence score**: How reliable the projection is

## How the forecast works

Creator Payments calculates your forecast by adding up known and expected revenue sources. This "bottom-up" approach is more accurate than simply assuming past trends will continue.
...
To keep forecasts realistic, Creator Payments automatically excludes:
...
The more information Creator Payments has, the better your forecast:
...
When you [track billable hours](/docs/track-time-timer), Creator Payments can estimate unbilled revenue. Link your tracked time to projects with hourly rates.
...
Creator Payments may show warnings on your forecast:
...
**"Limited history"**: Not enough historical data to calculate reliable baselines. Accuracy improves as you use Creator Payments longer.
