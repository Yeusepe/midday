...
description: How Creator Payments calculates your financial metrics and what affects each number.
section: reports
order: 0
---

Creator Payments gives you real-time visibility into your business finances. This guide explains how each metric is calculated and what factors affect them.
...
Credit card "available balance" isn't your money—it's borrowed money you'll need to pay back. Creator Payments shows only the cash you actually have.

### Multi-currency accounts

If you have accounts in different currencies, Creator Payments converts them to your base currency using current exchange rates. Set your base currency in [Settings](https://app.midday.ai/settings).
...
Creator Payments calculates averages over 3-6 months to smooth out one-time spikes.
...
Creator Payments excludes credit card payments from burn rate automatically. The actual expenses on your credit card still count.
...
Creator Payments shows net profit (all expenses included). For gross profit (revenue minus only cost of goods sold), filter your reports to exclude operating expenses.
...
Unlike simple trend projections, Creator Payments builds forecasts from known revenue sources:
