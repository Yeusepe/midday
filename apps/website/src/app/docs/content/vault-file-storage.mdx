...
The Vault is your centralized document storage in Creator Payments. Store contracts, receipts, statements, and any business documents—all searchable and organized.

## What is the Vault

The Vault is a secure file storage system built into Creator Payments. Unlike your inbox (which captures receipts for transaction matching), the Vault is for any document you want to keep:
