...
export const metadata = createPageMetadata({
  ...
  description:
    "Privacy Policy for Creator Payments. Learn how we collect, use, and protect your personal data.",
  path: "/policy",
  og: {
    title: "Privacy Policy",
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  YUCP Studio ("us", "we", or "our") operates the Creator Payments
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Service is the Creator Payments application operated by
                        YUCP Studio
                      </p>
                    </div>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    YUCP Studio uses the collected data for various purposes:
                  </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Creator Payments' use of information received from Google APIs will
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If you are from the European Economic Area (EEA), YUCP
                    Studio's legal basis for collecting and using the personal
                    information described in this Privacy Policy depends on the
                    Personal Data we collect and the specific context in which
                    we collect it.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    YUCP Studio may process your Personal Data because:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    YUCP Studio will retain your Personal Data only for as
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    YUCP Studio will also retain Usage Data for internal
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    YUCP Studio will take all the steps reasonably necessary
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        If YUCP Studio is involved in a merger, acquisition
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Under certain circumstances, YUCP Studio may be
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        YUCP Studio may disclose your Personal Data in the
                        good faith belief that such action is necessary to:
                      </p>
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        <li>To comply with a legal obligation</li>
                        <li>
                          To protect and defend the rights or property of YUCP
                          Studio
                        </li>
                        <li>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    you have certain data protection rights. YUCP Studio aims
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      YUCP Studio relied on your consent to process your
                      personal information.
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-2">
