...
export const metadata = createPageMetadata({
  title: "Story",
  description:
    "Why we built Creator Payments. Learn about our mission to help one-person companies stay on top of their business finances without the manual work.",
  path: "/story",
  og: { title: "Our Story", description: "Why we built Creator Payments" },
});
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4 text-center">
              <h1 className="font-serif text-3xl lg:text-3xl xl:text-3xl 2xl:text-3xl 3xl:text-4xl leading-tight lg:leading-tight xl:leading-[1.3] text-foreground">
                Why we started Creator Payments
              </h1>
            </div>
            ...
            <div className="prose prose-sm sm:prose-base max-w-none space-y-8 font-sans text-foreground">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Creator Payments keeps the moving parts of your business connected as
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Instead of pulling information out of the system, Creator Payments
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Creator Payments does not replace your accountant. It sits in between
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Creator Payments is built for founders who run real businesses without
