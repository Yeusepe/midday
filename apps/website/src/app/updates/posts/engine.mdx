---
title: "Creator Payments Engine"
publishedAt: "2024-06-18"
summary: "The core of Creator Payments is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more."
image: "/images/engine.png"
tag: "Updates"
---

The core of Creator Payments is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more.
...
We provide an API that gives our services transformed transactions, accounts, and balances for Creator Payments to use. Here is how we built it and the technologies we chose.
...
<br />
Creator Payments is fully open source. Feel free to check out our code [here](https://git.new/midday).
