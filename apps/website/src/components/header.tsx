      ...
      <nav className="fixed top-9 left-0 right-0 z-50 w-full">
        ...
        >
          ...
          <Link
            ...
            aria-label="Creator Payments - Go to homepage"
          >
                          ...
                          >
                            ...
                            <div className="bg-background border-t border-border p-2.5 flex items-center justify-between gap-4">
                              <div className="flex-1">
                                ...
                                <span className="font-sans text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-200">
                                  See how founders use Creator Payments
                                </span>
                              </div>
                              {(() => {
                                const testimonial =
                            ...
                            <div>
                              {[
                                ...
                                },
                                {
                                  href: "/docs",
                                  title: "Documentation",
                                  desc: "Learn how to use Creator Payments.",
                                  external: false,
                                },
                                {
                                  href: "/agents",
                              ...
                              {[
                                {
                                  ...
                                  title: "Developer & API",
                                  desc: "Programmatic access to Creator Payments.",
                                  external: true,
                                },
                                {
                                  href: "/sdks",
