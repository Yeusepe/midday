...
const faqs: FAQItem[] = [
  {
    question: "What is Creator Payments?",
    answer:
      "Creator Payments is a business workspace for one-person companies. It brings transactions, receipts, invoices, time tracking, and files into one connected system so you always know what's going on in your business.",
  },
  {
    question: "Who is Creator Payments for?",
    answer:
      "Creator Payments is built for founders running their company on their own who want clarity and control over their business without spending time on manual admin or spreadsheets.",
  },
  {
    question: "Do I need financial or accounting knowledge to use Creator Payments?",
    answer:
      "No. Creator Payments is designed for day-to-day use by non-financial users. It helps you stay organized, informed, and in control without requiring accounting expertise.",
  },
  {
    question: "How does Creator Payments connect to my bank?",
    answer:
      "Creator Payments connects to over 25,000 banks worldwide. Once connected, transactions are imported automatically and kept up to date.",
  },
  {
    question: "How do receipts and invoices get into Creator Payments?",
    answer:
  ...
  {
    question: "Can I create invoices in Creator Payments?",
    answer:
  ...
  {
    question: "Is Creator Payments secure?",
    answer:
      "Yes. Creator Payments uses industry-standard security practices to protect your data. You control what gets connected and shared at all times.",
  },
  {
