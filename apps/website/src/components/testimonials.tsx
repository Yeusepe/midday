...
const allTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content:
      "Invoice reconciliation used to take a full day each month and was always stressful. With Creator Payments, that work is mostly gone and we finally have a clear financial overview.",
    fullContent:
  ...
  },
  {
    ...
    content:
      "Managing invoicing, projects, and finances across tools slowed my daily work. Creator Payments brought everything into one place and made my workflow much simpler.",
    fullContent:
  ...
  },
  {
    ...
    content:
      "My previous accounting setup was fragmented and didn't support my bank. Creator Payments made invoicing easier and sharing clean data with my tax advisor straightforward.",
    fullContent:
  ...
  },
  {
    ...
    content:
      "Without Creator Payments, I had no real visibility into our cash and relied entirely on my accountant. It gave me clarity without having to learn complex accounting tools.",
    fullContent:
      "Company\nThetis Medical is a medical device company.\n\nChallenge\nWithout Creator Payments, I had no real visibility into our cash and relied entirely on my accountant.\n\nImpact\nMidday gave me clarity without having to learn complex accounting tools.\n\nFavorite features\nFinancial visibility and cash flow tracking.",
    video:
        ...
        <div className="max-w-[1400px] mx-auto mb-16 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="font-sans text-base text-muted-foreground leading-normal mb-8">
              See how solo founders use Creator Payments to run their businesses with less
              admin.
            </p>
          </div>
        </div>
