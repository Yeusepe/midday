...
User's next page load:
  ...
  |-- TrialGuard shows UpgradeContent ("Continue with Creator Payments" + plans)
...
| `apps/dashboard/src/components/upgrade-content.tsx` | "Continue with Creator Payments" page with plan selection |
