...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect ChatGPT to your Creator Payments financial data via MCP with one-click OAuth.",
  description: `Connect ChatGPT to your Creator Payments account using the Model Context Protocol (MCP). No API key needed — authentication is handled automatically via OAuth.
...
2. Paste this URL as the connector URL: \`https://api.payments.yucp.club/mcp\`
