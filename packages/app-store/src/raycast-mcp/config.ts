...
export default {
  ...
  logo: Logo,
  short_description:
    "Access Creator Payments financial data directly from Raycast via MCP.",
  description: `Connect Raycast to your Creator Payments account using the Model Context Protocol (MCP).
...
2. Add Creator Payments as an MCP server in Raycast
3. @-mention Creator Payments in Raycast AI`,
  images: [],
