...
export const baseConfig = {
  ...
  logo: Logo,
  short_description:
    "Use the Creator Payments assistant on the go — upload receipts, track expenses, create invoices, and manage your finances directly from Telegram.",
  description:
    "Take Creator Payments with you. Connect Telegram to access the full Creator Payments assistant from your phone.\n\n**Creator Payments Assistant**\nAsk questions about your finances, get spending summaries, check outstanding invoices, or look up any transaction — all through a natural conversation.\n\n**Upload Receipts & Invoices**\nSnap a photo or forward a receipt and Creator Payments extracts the details automatically. It matches documents to the right transactions so your books stay up to date.\n\n**Create & Track Invoices**\nDraft and send invoices, check payment status, and get notified when invoices are paid or overdue — without opening the app.\n\n**Quick Setup**\nOpen Telegram from Creator Payments or scan the QR code to start the bot. No extra apps needed — just start chatting.",
  settings: [
    {
      id: "transactions",
      label: "Transactions",
