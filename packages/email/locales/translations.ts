  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on Creator Payments`,
        "invite.preview": `Join ${params?.teamName} on Creator Payments`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Creator Payments`,
        "invite.preview": `Gå med i ${params?.teamName} på Creator Payments`,
